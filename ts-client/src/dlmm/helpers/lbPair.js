 ...
 */
function getTokensMintFromPoolAddress(connection, poolAddress, opt) {
    return __awaiter(this, void 0, void 0, function () {
        var provider, program, poolAccount;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    provider = new anchor_1.AnchorProvider(connection, {}, anchor_1.AnchorProvider.defaultOptions());
                    program = new anchor_1.Program(idl_1.IDL, constants_1.LBCLMM_PROGRAM_IDS[(_a = opt === null || opt === void 0 ? void 0 : opt.cluster) !== null && _a !== void 0 ? _a : "mainnet-beta"], provider);
                    return [4 /*yield*/, program.account.lbPair.fetchNullable(new web3_js_1.PublicKey(poolAddress))];
                case 1:
                    poolAccount = _b.sent();
                    if (!poolAccount)
